...
function year_list(){
	...
	document.getElementById("year_b4_prev_year").innerHTML = current_year - 2;
	// document.getElementById("year_b4_prev_year").value = current_year.toString().substr(-2) - 2;
	document.getElementById("prev_year").innerHTML = current_year - 1;
	// document.getElementById("prev_year").value = current_year.toString().substr(-2) - 1;
	document.getElementById("curr_year").innerHTML = current_year;
	// document.getElementById("curr_year").value = current_year.toString().substr(-2);
}
...
$( "form" ).on( "submit", function(e) {
	...
	document.getElementById("soft_warn").innerHTML = 'Fill all mandatory fields correctly!';
}
});
